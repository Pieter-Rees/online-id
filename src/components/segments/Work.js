            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-48 mx-auto">
                <div className="flex self-center justify-center">
                    <div className="flex items-center">
                        <ContentContainer
                            content={
                                ' Currently I am working @ GoodUp. We provide The #1 tech solution for activating employees on your company purpose. I am always up for a nice talk about innovative ideas. Please drop me a line via'
                            }
                        />
                        <a
